                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content:
                            const Text('You have checked all notifications.'),
                        actions: [
                          TextButton(
                            onPressed: () {
                ...
                children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildAnimatedStatCard(
                                'Strongest Subject',
                                _subjects[percentages.indexOf(percentages
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          _getColorForPercentage(averagePercentage)
                              .withOpacity(0.15),
                          _getColorForPercentage(averagePercentage)
                              .withOpacity(0.05),
                        ],
              ...
              _buildFeatureCard(
                ...
                () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ReduAIScreen(),
                    ),
                  );
                },
              ),
