...
class ThemeProvider with ChangeNotifier {
  ...
  static final Map<String, ColorScheme> colorSchemes = {
    ...
    'Rose Petal Light': const ColorScheme.light(
    ...
    'Rose Petal Dark': const ColorScheme.dark(
    ...
    'Ruby Red Light': const ColorScheme.light(
    ...
    'Ruby Red Dark': const ColorScheme.dark(
    ...
    'Black/White Light': const ColorScheme.light(
    ...
    'Black/White Dark': const ColorScheme.dark(
    ...
    'Yellow/White Light': const ColorScheme.light(
    ...
    'Yellow/White Dark': const ColorScheme.dark(
